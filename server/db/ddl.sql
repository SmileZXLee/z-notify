...
CREATE TABLE `t_feedback` (
  ...
  KEY `idx_project_username` (`project_id`, `username`, `createtime` DESC) USING BTREE,
  KEY `idx_project_updatetime` (`project_id`, `updatetime` DESC, `createtime` DESC) USING BTREE,
...
CREATE TABLE `t_notice` (
  ...
  KEY `idx_project_expire_create` (`project_id`, `expiretime`, `createtime` DESC),
...
CREATE TABLE `t_statistics` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `project_id_key2` (`project_id`) USING BTREE,
  KEY `idx_project_createtime` (`project_id`, `createtime` DESC) USING BTREE,
  KEY `idx_project_tag` (`project_id`, `tag`) USING BTREE,
  KEY `idx_project_ip` (`project_id`, `ip`) USING BTREE,
...
CREATE TABLE `t_version` (
  ...
  KEY `project_id_key2` (`project_id`) USING BTREE,
  KEY `idx_project_version` (`project_id`, `version`) USING BTREE,
